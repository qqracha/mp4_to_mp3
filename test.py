...
class SettingsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        folders_group.setStyleSheet(
            "QGroupBox {color: #fff; border: 2px solid #555; border-radius: 5px; font-weight: bold; margin-top: 10px; padding-top: 10px;}"
        ...
        # ceneral settings group (CheckBoxes)
        ...
        self.delete_after_check.setStyleSheet(checkbox_style)
        ...
        self.open_folder_check.setStyleSheet(checkbox_style)
        ...
        save_btn.setStyleSheet(
            "QPushButton {background-color: #4CAF50; color: white; border: none; padding: 10px; font-size: 14px; border-radius: 5px;}"
            "QPushButton:hover {background-color: #45a049;}"
        )
        save_btn.clicked.connect(self.save_settings)
        cancel_btn = QPushButton('Cancel')
        cancel_btn.setStyleSheet(
            "QPushButton {background-color: #f44336; color: white; border: none; padding: 10px; font-size: 14px; border-radius: 5px;}"
    ...
    def _get_input_style(self):
        return (
            "QLineEdit {background-color: #1e1e1e; color: #ffffff; border: 1px solid #555; padding: 5px; border-radius: 3px;}"
        )

    def _get_small_btn_style(self):
        return (
            "QPushButton {background-color: #555; color: white; border: none; padding: 5px 15px; border-radius: 3px;}"
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowIcon(QIcon(str(self.script_dir / "icon.ico")))
        ...
        settings_btn.setStyleSheet(
            "QPushButton {background-color: #666; color: white; border: none; padding: 5px 15px; font-size: 18px; border-radius: 5px;}"
        ...
        self.select_btn.setStyleSheet(
            "QPushButton {background-color: #2196F3; color: white; border: none; padding: 10px; font-size: 16px; border-radius: 5px;}"
        ...
        self.convert_btn.setStyleSheet(
            "QPushButton {background-color: #4CAF50; color: white; border: none; padding: 15px; font-size: 18px; border-radius: 5px;}"
            "QPushButton:hover {background-color: #45a049;}"
        ...
        self.log_area.setStyleSheet(
            "QTextEdit {background-color: #1e1e1e; color: #00ff00; border: 1px solid #555; padding: 10px; font-family: 'Courier New', monospace; font-size: 13px;}"
        )
